...
| 16 | DELETE|/api/shop/seller-delete-product/:id             | 200 OK      | private | Delete Item in Collection     |
|17  |GET	 |/api/shop/seller-get-shop-products	|200 OK	|private|	Seller get products|
|18  |	GET	|/api/shop/user-get-products|	200 OK	|public	|Buyer| get all products|
