...
const imagePath = path.join(
  __dirname,
  "../../../__test__/images/69180880-2138-11eb-8b06-03db3ef1abad.jpeg"
);
...
describe("Product and Collection API Tests", () => {
  ...
  describe("POST|PUT /api/collection/create|update-product/:id", () => {
    ...
    before((done) => {
      router()
        ...
        .send({
          ...
          description: "Description for product collection",
        })
        .end((err, res) => {
    ...
    it("should update a product successfully", (done) => {
      router()
        .put(`/api/collection/update-product/${productId}`)
        .set("Authorization", `Bearer ${token}`)
...
describe("isProductExist Middleware", () => {
  it("should handle errors and return 500 status", async () => {
    ...
    sinon
      .stub(productRepositories, "findItemByAttributes")
...
describe("isCollectionExist Middleware", () => {
  it("should handle errors and return 500 status", async () => {
    ...
    sinon
      .stub(productRepositories, "findByModelAndAttributes")
      .throws(new Error("Database error"));
